...
public class ObjProxy_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.brmayi.yuna.util.ObjProxy"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ObjProxy_ESTest_scaffolding.class.getClassLoader() ,
      "com.brmayi.yuna.util.ObjProxy"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ObjProxy_ESTest_scaffolding.class.getClassLoader()); 
